...
module.exports = {
	...
	// Project options.
	projectURL: 'wp-install.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'plugin-slug', // Your textdomain here.
	translationFile: 'plugin-slug.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'PluginSlug', // Package name.
	bugReport: 'https://github.com/mindmantra/plugin-slug/issues', // Where can users report bugs.
	lastTranslator: 'Dhaval Shah <themindmantra@gmail.com>', // Last translator Email ID.
	team: 'Mindmantra <themindmantra@gmail.com>', // Team's Email ID.
